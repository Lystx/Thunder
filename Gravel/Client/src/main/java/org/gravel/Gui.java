...
import org.gravel.utils.SystemInfo;
...
public class Gui extends JFrame {
    ...
    public Gui() {
        setTitle("Gravel | Messenger");
        addWindowListener(new WindowAdapter() {
            @Override
            public void windowClosing(WindowEvent e) {
                //TODO: STOPPING CLIENT
                System.exit(0);
            }
        });
        ...
        commandInput.setToolTipText("Enter a Message");
        ...
        execCommand = new JButton("Send");
        execCommand.setToolTipText("Enter a Message");
