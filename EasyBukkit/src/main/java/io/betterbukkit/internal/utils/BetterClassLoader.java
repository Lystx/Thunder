package io.betterbukkit.internal.utils;
...
@Getter
public class BetterClassLoader {

    private final File file;

    public BetterClassLoader(File file) {
        this.file = file;
    }
    ...
    public Class<?> findClass(String name) {
        try {
            URLClassLoader child  = new URLClassLoader(new URL[] {new URL("file:" + this.file.toString())}, EasyBukkit.class.getClassLoader());
