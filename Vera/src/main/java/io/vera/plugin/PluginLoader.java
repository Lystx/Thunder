        ...
        try (JarFile jarFile = new JarFile(pluginFile)) {
            ...
            for (String name : names) {
                ...
                if (cls.isAssignableFrom(Listener.class)) {
                    VeraServer.getInstance().getEventController().registerEvent(cls.asSubclass(Listener.class).getConstructor().newInstance());
                }
            ...
            for (Class<? extends CommandListener> cls : commandClasses) {
                VeraServer.getInstance().getCommandHandler().register(plugin, cls.asSubclass(CommandListener.class).getConstructor().newInstance());
            }
            ...
            return plugin;
        } catch (IOException | IllegalAccessException | InstantiationException | NoSuchMethodException | InvocationTargetException | NotFoundException | ClassNotFoundException e) {
            throw new RuntimeException(e);
        }
    }
